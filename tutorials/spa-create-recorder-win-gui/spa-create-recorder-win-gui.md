...
# Automate SAP GUI for Windows application using Recorder
...
1. Choose **Record** ![Record icon](10.png) to initiate the recording. 
...
3. Choose **Enter** ![Enter icon](11.png)
...
1. Enter the Sales Order transaction ID: **VA01**.

2. Choose **Enter** ![Enter icon](11.png)
...
1. Fill the following values for order type:
...
1. Now you will set the order detail values:
...
3. Choose **Save** to complete the process of recording the sales order application.

    <!-- border -->![Save](17.png)

4. Choose **Stop** to stop the recording.
